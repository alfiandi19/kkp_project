			...
			<div class="col-md-3 col-sm-6 col-xs-6">
				<div class="footer">
					...
					<div class="footer-logo">
						<a class="logo" href="#">
							<img src="frontend/img/logobawah.png" alt="">
						</a>
					</div>
					<!-- /footer logo -->

					<p>Toko online penyedia alat elektronik terlengkap, tersedia berbagai macam perangkat elektronik.</p>
			...
			<div class="col-md-3 col-sm-6 col-xs-6">
				<div class="footer">
					...
					<ul class="footer-social">
						<li><a href="https://www.facebook.com/nowme.id"><i class="fa fa-facebook"></i></a></li>
						<li><a href="#"><i class="fa fa-twitter"></i></a></li>
						<li><a href="https://www.instagram.com/nowme_id/"><i class="fa fa-instagram"></i></a></li>
		...
		<div class="row">
			<div class="col-md-8 col-md-offset-2 text-center">
				...
				<div class="footer-copyright">
					...
					Copyright &copy;<script>document.write(new Date().getFullYear());</script> PT. Nowme Indonesia
